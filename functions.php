...
function gamekoopjes_scripts() {
	wp_enqueue_style( 'gamekoopjes-style', get_stylesheet_uri() );

	wp_enqueue_script( 'gamekoopjes-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'gamekoopjes-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
